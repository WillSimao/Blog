export class Blog {
    constructor() {
        this.cards = [
            ...
            {
                date: '20 de jul, 2021',
                title: 'Antonio McAfee, criador do antivírus McAfee, morre',
                description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vestibulum auctor est. Nam vitae finibus ante. Duis lobortis tellus vel diam fringilla, eu ullamcorper ex iaculis. Praesent et auctor justo. Vestibulum nisl orci, lacinia venenatis leo sit amet, pulvinar tincidunt risus. Phasellus nisl dui, cursus a lectus et, interdum ullamcorper libero.'
            },
            {
                date: '20 de jul, 2021',
            ...
            {
                date: '20 de jul, 2021',
                title: 'Jhonatan McAfee, criador do antivírus McAfee, morre',
                description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vestibulum auctor est. Nam vitae finibus ante. Duis lobortis tellus vel diam fringilla, eu ullamcorper ex iaculis. Praesent et auctor justo. Vestibulum nisl orci, lacinia venenatis leo sit amet, pulvinar tincidunt risus. Phasellus nisl dui, cursus a lectus et, interdum ullamcorper libero.'
            },
    ...
    selectors() {
        ...
        this.noResults = document.querySelector('.main_noResult')
    }

    events() {
        this.inputSearch.addEventListener('input', (e) => this.searchBlog(e, this.cards));
    }

    renderListCards (cards = this.cards) {
        ...
        cards.forEach(i => {
            ...
            <li class="main_wrapper-cards_li">
                <div class="main_wrapper-cards_li_container">
                    <span class="main_wrapper-cards_li_container_date">${i.date}</span>
                    <button id="buttonCount" class="main_wrapper-cards_li_container_button">
                        <svg id="icon" width="200" height="200" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    searchBlog(e, cards) {
        ...
        const resultado = cards.filter(card => card.title.toLowerCase().includes(searchTerm));

        if(resultado.length > 0) {
            this.renderListCards(resultado)
        } else {
            this.noResults.style.display = 'flex';
            this.containerCards.innerHTML = '';
        }

        if (this.containerCards.innerHTML != '') {
